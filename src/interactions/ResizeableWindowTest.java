...
public class ResizeableWindowTest extends BaseTest{
    ...
    iap.clickresizable();
    ResizeableWindowPage rp=new ResizeableWindowPage();
    rp.ResizableTest();
    rp.setresizeboxwithrestrict();
    rp.setresizewithoutrestrict();
